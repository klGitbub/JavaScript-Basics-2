...
//CODE HERE
const empOne = new Employee('Sam', 'weekday mornings, weekday afternoons')
...
//CODE HERE
const manager = new Manager('Tina', 'weekday mornings, weekday afternoons', ['Gina', 'Xavier'])
